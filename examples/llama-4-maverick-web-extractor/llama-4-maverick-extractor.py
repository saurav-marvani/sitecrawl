...
def extract_company_info(urls, prompt, company, api_key):
    ...
    try:
        print(f"{Colors.CYAN}Making request to Sitecrawl API...{Colors.RESET}")
        ...
        return poll_sitecrawl_result(extraction_id, api_key, interval=5, max_attempts=120)  # Increased polling attempts
