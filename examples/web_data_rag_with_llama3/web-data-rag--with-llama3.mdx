...
description: "Learn how to use Sitecrawl, Groq Llama 3, and Langchain to build a 'Chat with your website' bot."
---

## Setup

Install our python dependencies, including langchain, groq, faiss, ollama, and sitecrawl-py. 

```bash
pip install --upgrade --quiet langchain langchain-community groq faiss-cpu ollama sitecrawl-py
```
...
To be able to get all the data from a website and make sure it is in the cleanest format, we will use Sitecrawl. Sitecrawl integrates very easily with Langchain as a document loader.

Here is how you can load a website with Sitecrawl:

```python
from langchain_community.document_loaders import SitecrawlLoader  # Importing the SitecrawlLoader

url = "https://sitecrawl.dev"
loader = SitecrawlLoader(
    api_key="fc-YOUR_API_KEY", # Note: Replace 'YOUR_API_KEY' with your actual Sitecrawl API key
...
You have now built a 'Chat with your website' bot using Llama 3, Groq Llama 3, Langchain, and Sitecrawl. You can now use this bot to answer questions based on the documentation of your website.
