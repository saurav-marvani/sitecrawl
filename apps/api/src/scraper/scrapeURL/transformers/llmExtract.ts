...
- includePaths: string[] - URL pathname regex patterns that include matching URLs in the crawl. Only the paths that match the specified patterns will be included in the response. For example, if you set "includePaths": ["blog/.*"] for the base URL sitecrawl.dev, only results matching that pattern will be included, such as https://www.sitecrawl.dev/blog/sitecrawl-launch-week-1-recap.
- excludePaths: string[] - URL pathname regex patterns that exclude matching URLs from the crawl. For example, if you set "excludePaths": ["blog/.*"] for the base URL sitecrawl.dev, any results matching that pattern will be excluded, such as https://www.sitecrawl.dev/blog/sitecrawl-launch-week-1-recap.
