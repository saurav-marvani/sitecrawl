...
const emailTemplates: Record<NotificationType, EmailTemplate> = {
  [NotificationType.RATE_LIMIT_REACHED]: {
    subject: "Rate Limit Reached - Sitecrawl",
    html: "Hey there,<br/><p>You've hit one of the Sitecrawl endpoint's rate limit! Take a breather and try again in a few moments. If you need higher rate limits, consider upgrading your plan. Check out our <a href='https://sitecrawl.dev/pricing'>pricing page</a> for more info.</p><p>If you have any questions, feel free to reach out to us at <a href='mailto:help@sitecrawl.com'>help@sitecrawl.com</a></p><br/>Thanks,<br/>Sitecrawl Team<br/><br/>Ps. this email is only sent once every 7 days if you reach a rate limit.",
  },
  [NotificationType.AUTO_RECHARGE_SUCCESS]: {
    subject: "Auto recharge successful - Sitecrawl",
    html: (ctx: NotificationContext) => {
      const creditsText =
        ctx.autoRechargeCredits != null
          ? `${ctx.autoRechargeCredits.toLocaleString()} credits`
          : "additional credits";
      return `Hey there,<br/><p>Your account was successfully recharged with ${creditsText} because your remaining credits were below the threshold. Consider upgrading your plan at <a href='https://sitecrawl.dev/pricing'>sitecrawl.dev/pricing</a> to avoid hitting the limit.</p><br/>Thanks,<br/>Sitecrawl Team<br/>`;
    },
  },
  [NotificationType.AUTO_RECHARGE_FAILED]: {
    subject: "Auto recharge failed - Sitecrawl",
    html: "Hey there,<br/><p>Your auto recharge failed. Please try again manually. If the issue persists, please reach out to us at <a href='mailto:help@sitecrawl.com'>help@sitecrawl.com</a></p><br/>Thanks,<br/>Sitecrawl Team<br/>",
  },
  [NotificationType.AUTO_RECHARGE_FREQUENT]: {
    subject: "Consider upgrading your plan - Sitecrawl",
    html: "Hey there,<br/><p>We've noticed frequent auto-recharges on your account. To optimize your costs and get better features, we recommend upgrading to a higher tier plan with:</p><ul><li>More included credits</li><li>Better pricing per credit</li><li>Higher rate limits</li></ul><p>View our plans at <a href='https://sitecrawl.dev/pricing'>sitecrawl.dev/pricing</a>. If none fit your needs, email us at <a href='mailto:help@sitecrawl.com'>help@sitecrawl.com</a> with 'Scale pricing' in the subject and we'll quickly help you move to a scale plan.</p><br/>Thanks,<br/>Sitecrawl Team<br/>",
  },
  [NotificationType.CONCURRENCY_LIMIT_REACHED]: {
    subject: "You could be scraping faster - Sitecrawl",
    html: `Hey there,
    <br/>
    ...
    <p>You're hitting the concurrency limit for your plan quite often, which means Sitecrawl can't scrape as fast as it could. But don't worry, it is not failing your requests and you are still getting your results.</p>
    <p>This is just to let you know that you could be scraping faster by having more concurrent browsers. Consider upgrading your plan at <a href='https://sitecrawl.dev/pricing'>sitecrawl.dev/pricing</a>.</p>
    <p>You can modify your notification settings anytime at <a href='https://www.sitecrawl.dev/app/account-settings'>sitecrawl.dev/app/account-settings</a>.</p>
    <br/>Thanks,<br/>Sitecrawl Team<br/>`,
  },
  [NotificationType.AGENT_SPONSOR_CONFIRM]: {
    subject: "An AI agent requested an API key under your email - Sitecrawl",
    html: "",
  },
};
...
async function sendEmailNotification(
  ...
  try {
    ...
    const { error } = await resend.emails.send({
      from: "Sitecrawl <notifications@notifications.sitecrawl.dev>",
      to: [email],
      reply_to: "help@sitecrawl.com",
