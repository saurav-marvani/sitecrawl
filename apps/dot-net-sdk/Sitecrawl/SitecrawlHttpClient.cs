...
/// </summary>
internal class SitecrawlHttpClient
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    return JsonSerializer.Deserialize<T>(bodyStr, JsonOptions)
                        ?? throw new SitecrawlException("Failed to deserialize response");
                }
            ...
            catch (HttpRequestException ex)
            {
                ...
                throw new SitecrawlException($"Request failed: {ex.Message}", ex);
            }
            finally
            {
                response?.Dispose();
