...
using MonitorModel = Sitecrawl.Models.Monitor;

namespace Sitecrawl;

/// <summary>
/// Client for the Sitecrawl v2 API.
///
/// <example>
/// <code>
...
/// </example>
/// </summary>
public class SitecrawlClient
{
    private const string DefaultApiUrl = "https://api.sitecrawl.dev";
    ...
    private readonly SitecrawlHttpClient _http;

    /// <summary>
    /// Creates a new SitecrawlClient with the specified API key.
    /// </summary>
    /// <param name="apiKey">The Sitecrawl API key.</param>
    /// <param name="apiUrl">Optional API base URL (defaults to https://api.sitecrawl.dev).</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Scrape response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await PollCrawlAsync(
            start.Id ?? throw new SitecrawlException("Crawl start did not return a job ID"),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (body.TryGetValue("options", out var nested) && nested is JsonElement nestedElement)
        {
            ...
            var nestedDict = JsonSerializer.Deserialize<Dictionary<string, object>>(
                nestedElement.GetRawText(), SitecrawlHttpClient.JsonOptions);
            if (nestedDict != null)
            {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await PollBatchScrapeAsync(
            start.Id ?? throw new SitecrawlException("Batch scrape start did not return a job ID"),
            pollIntervalSec, timeoutSec, cancellationToken);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var optionsJson = JsonSerializer.Serialize(
            ...
            SitecrawlHttpClient.JsonOptions);
        ...
        return response.Data ?? throw new SitecrawlException("Parse response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Map response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Create monitor response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Get monitor response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Update monitor response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Run monitor response contained no data");
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var check = response.Data ?? throw new SitecrawlException("Get monitor check response contained no data");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return response.Data ?? throw new SitecrawlException("Search response contained no data");
    }
    ...
    private static Dictionary<string, object> BuildBody(object? options)
    {
        ...
        {
            var json = JsonSerializer.Serialize(options, SitecrawlHttpClient.JsonOptions);
            body = JsonSerializer.Deserialize<Dictionary<string, object>>(json, SitecrawlHttpClient.JsonOptions)
    ...
    private static string? ResolveApiKey(string? apiKey)
    {
        ...
        var envKey = Environment.GetEnvironmentVariable("SITECRAWL_API_KEY");
    ...
    private static string ResolveApiUrl(string? apiUrl)
    {
        ...
        var envUrl = Environment.GetEnvironmentVariable("SITECRAWL_API_URL");
