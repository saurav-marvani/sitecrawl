...
{
    private static readonly JsonSerializerOptions JsonOptions = SitecrawlHttpClient.JsonOptions;
    ...
    public void SearchOptions_SerializesCorrectly()
    {
        var options = new SearchOptions
        {
            ...
            Tbs = "qdr:w",
            Highlights = false,
            IncludeDomains = new() { "sitecrawl.dev" },
        ...
        Assert.Contains("\"includeDomains\":[\"sitecrawl.dev\"]", json);
    ...
    public void Document_DeserializesCorrectly()
    {
        ...
        Assert.Equal("https://storage.googleapis.com/sitecrawl/video.mp4", doc.Video);
    ...
    public void QueryFormat_HasCorrectMode()
    {
        ...
        Assert.Contains("\"prompt\":\"What is Sitecrawl?\"", json);
    ...
    public void CrawlResponse_DeserializesCorrectly()
    {
        var json = """
        {
            "success": true,
            "id": "crawl-abc",
            "url": "https://api.sitecrawl.dev/v2/crawl/crawl-abc"
        }
        """;
    ...
    public void MonitorSearchTarget_SerializesCorrectly()
    {
        ...
        {
            Queries = new List<string> { "sitecrawl pricing", "sitecrawl changelog" },
            SearchWindow = "24h",
            IncludeDomains = new List<string> { "sitecrawl.dev" },
