#!/usr/bin/env elixir
# generate.exs — Auto-generates the Sitecrawl Elixir SDK from the OpenAPI spec.
#
# Usage:
#   mix run generate.exs
#
# This script:
# 1. Fetches the Sitecrawl v2 OpenAPI JSON spec
# 2. Parses all endpoints and generates Elixir wrapper functions with NimbleOptions validation
# 3. Writes lib/sitecrawl.ex
# 4. Bumps the patch version in mix.exs if the generated code changed

defmodule Sitecrawl.Generator do
  @openapi_url "https://raw.githubusercontent.com/sitecrawl/sitecrawl-docs/main/api-reference/v2-openapi.json"
  @output_file "lib/sitecrawl.ex"
  @mix_file "mix.exs"
  ...
  defp generate_module(spec) do
    ...
    defmodule Sitecrawl do
      @moduledoc \"\"\"
      Auto-generated Sitecrawl API #{api_version} client.
