...
import com.sitecrawl.errors.AuthenticationException;
import com.sitecrawl.errors.SitecrawlException;
import com.sitecrawl.errors.RateLimitException;
import okhttp3.*;
...
/**
 * Internal HTTP client for making authenticated requests to the Sitecrawl API.
 * Handles retry logic with exponential backoff.
 */
class SitecrawlHttpClient {
    ...
    SitecrawlHttpClient(String apiKey, String baseUrl, long timeoutMs, int maxRetries, double backoffFactor) {
    ...
    <T> T post(String path, Object body, Class<T> responseType, Map<String, String> extraHeaders) {
        ...
        try {
            ...
            throw new SitecrawlException("Failed to serialize request body", e);
        }
            ...
            try {
                try (Response response = httpClient.newCall(request).execute()) {
                    ...
                    if (code >= 400 && code < 500 && code != 408 && code != 409) {
                        throw new SitecrawlException(errorMessage, code, errorCode, null);
                    }
                ...
                throw new SitecrawlException("Request failed: " + e.getMessage(), e);
            }
        }
    }
    ...
    private void sleepWithBackoff(int attempt) {
        ...
        try {
            ...
            throw new SitecrawlException("Request interrupted during retry backoff", e);
        }
    }
}
