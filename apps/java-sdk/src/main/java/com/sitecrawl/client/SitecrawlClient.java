package com.sitecrawl.client;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.sitecrawl.errors.SitecrawlException;
import com.sitecrawl.errors.JobTimeoutException;
...
public class SitecrawlClient {
    ...
    private static final String DEFAULT_API_URL = "https://api.sitecrawl.dev";
    ...
    private final SitecrawlHttpClient http;
    private final Executor asyncExecutor;

    private SitecrawlClient(SitecrawlHttpClient http, Executor asyncExecutor) {
        this.http = http;
        this.asyncExecutor = asyncExecutor;
    }

    /**
     * Creates a new builder for constructing a SitecrawlClient.
     */
    ...
    /**
     * Creates a client from the SITECRAWL_API_KEY environment variable.
     */
    public static SitecrawlClient fromEnv() {
        String apiKey = System.getenv("SITECRAWL_API_KEY");
        if (apiKey == null || apiKey.isBlank()) {
            String sysProp = System.getProperty("sitecrawl.apiKey");
            if (sysProp == null || sysProp.isBlank()) {
                throw new SitecrawlException("SITECRAWL_API_KEY environment variable or sitecrawl.apiKey system property is required");
            }
            apiKey = sysProp;
        }
    ...
    public Document parse(ParseFile file, ParseOptions options) {
        ...
        try {
            ...
            throw new SitecrawlException("Failed to serialize parse options", e);
        }
    ...
    private void sleep(int seconds) {
        try {
            ...
            throw new SitecrawlException("Polling interrupted", e);
        }
    }
    ...
    public static final class Builder {
        ...
        /**
         * Sets the API key. Falls back to SITECRAWL_API_KEY env var or
         * sitecrawl.apiKey system property if not provided.
         */
        ...
        /**
         * Sets the API base URL. Defaults to https://api.sitecrawl.dev.
         * Falls back to SITECRAWL_API_URL env var if not provided.
         */
        ...
        public SitecrawlClient build() {
            ...
            if (resolvedKey == null || resolvedKey.isBlank()) {
                resolvedKey = System.getenv("SITECRAWL_API_KEY");
            }
            if (resolvedKey == null || resolvedKey.isBlank()) {
                resolvedKey = System.getProperty("sitecrawl.apiKey");
            }
            ...
            if (resolvedUrl == null || resolvedUrl.equals(DEFAULT_API_URL)) {
                String envUrl = System.getenv("SITECRAWL_API_URL");
            ...
            SitecrawlHttpClient http = new SitecrawlHttpClient(
                    resolvedKey, resolvedUrl, timeoutMs, maxRetries, backoffFactor, httpClient);
            return new SitecrawlClient(http, executor);
        }
    }
}
