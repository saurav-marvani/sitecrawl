...
from .utils.error_handler import SitecrawlError
...
class SitecrawlClient:
    ...
    This client provides a clean, modular interface to all Sitecrawl functionality.
    """

    @staticmethod
    def _is_cloud_service(url: str) -> bool:
        return "api.sitecrawl.dev" in url.lower()
    ...
    def __init__(
        ...
        """
        Initialize the Sitecrawl client.

        Args:
            api_key: Sitecrawl API key (or set SITECRAWL_API_KEY env var)
            api_url: Base URL for the Sitecrawl API
