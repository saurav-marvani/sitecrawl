...
from sitecrawl.v2.utils.validation import validate_scrape_options, prepare_scrape_options
...
class TestPrepareScrapeOptions:
    ...
    def test_prepare_query_format_with_mode(self):
        ...
        options = ScrapeOptions(
            formats=[QueryFormat(prompt="What is Sitecrawl?", mode="directQuote")]
        )
        result = prepare_scrape_options(options)
    ...
    def test_prepare_new_v2_fields(self):
        ...
        from sitecrawl.v2.types import Viewport, ScreenshotAction
