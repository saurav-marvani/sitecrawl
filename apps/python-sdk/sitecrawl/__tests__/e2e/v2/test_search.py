...
from sitecrawl.types import SearchData, Document, ScrapeOptions, SearchResultWeb, SearchResultNews, SearchResultImages

load_dotenv()

sitecrawl = Sitecrawl(api_key=os.getenv("API_KEY"), api_url=os.getenv("API_URL"))
...
def _is_document(entry) -> bool:
    try:
        from sitecrawl.v2.types import Document
...
def test_search_with_sources():
    ...
    assert 'sitecrawl' in all_web_text
...
def test_search_all_parameters():
    ...
    from sitecrawl.types import ScrapeOptions, JsonFormat, Location, WaitAction
    ...
    results = sitecrawl.search(
        ...
        scrape_options=ScrapeOptions(
            ...
            headers={"User-Agent": "Sitecrawl-Test/1.0"},
...
def test_search_formats_flexibility():
    ...
    from sitecrawl.types import ScrapeFormats
    
    # Test with list format
    results1 = sitecrawl.search(
