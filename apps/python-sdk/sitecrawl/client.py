...
A Sitecrawl client that enables you to scrape content from websites, crawl entire sites, search the web, and extract structured data using AI.
...
Usage:
    ...
    sitecrawl = Sitecrawl(api_key="your-api-key")
    result = sitecrawl.scrape("https://example.com")
...
from .v1 import V1SitecrawlApp, AsyncV1SitecrawlApp
from .v2 import SitecrawlClient as V2SitecrawlClient
from .v2.client_async import AsyncSitecrawlClient
from .v2.types import Document, ParseOptions, ScrapeOptions

logger = logging.getLogger("sitecrawl")

class V1Proxy:
    """Type-annotated proxy for v1 client methods."""
    _client: Optional[V1SitecrawlApp]
    
    def __init__(self, client_instance: Optional[V1SitecrawlApp]):
...
class V2Proxy:
    ...
    _client: Optional[V2SitecrawlClient]
    
    def __init__(self, client_instance: Optional[V2SitecrawlClient]):
        self._client = client_instance
...
class AsyncV1Proxy:
    """Type-annotated proxy for v1 client methods."""
    _client: Optional[AsyncV1SitecrawlApp]
    
    def __init__(self, client_instance: Optional[AsyncV1SitecrawlApp]):
        self._client = client_instance
...
class AsyncV2Proxy:
    """Proxy class that forwards method calls to the appropriate version client."""
    _client: Optional[AsyncSitecrawlClient] = None

    def __init__(self, client_instance: Optional[AsyncSitecrawlClient] = None):
        self._client = client_instance
...
class Sitecrawl:
    """
    Unified Sitecrawl client (v2 by default, v1 under ``.v1``).
    ...
    def __init__(
        self,
        api_key: str = None,
        api_url: str = "https://api.sitecrawl.dev",
        timeout: float = None,
        max_retries: int = 3,
        ...
        Args:
            api_key: Sitecrawl API key (or set ``SITECRAWL_API_KEY``)
        ...
        self._v1_client = V1SitecrawlApp(api_key=api_key, api_url=api_url) if V1SitecrawlApp else None
        self._v2_client = V2SitecrawlClient(
            api_key=api_key,
            api_url=api_url,
            timeout=timeout,
            max_retries=max_retries,
            backoff_factor=backoff_factor,
        ) if V2SitecrawlClient else None
...
class AsyncSitecrawl:
    """Async unified Sitecrawl client (v2 by default, v1 under ``.v1``)."""
    ...
    def __init__(
        ...
        # Initialize version-specific clients
        self._v1_client = AsyncV1SitecrawlApp(api_key=api_key, api_url=api_url) if AsyncV1SitecrawlApp else None
        self._v2_client = AsyncSitecrawlClient(
            api_key=api_key,
            api_url=api_url,
            timeout=timeout,
            max_retries=max_retries,
            backoff_factor=backoff_factor,
        ) if AsyncSitecrawlClient else None
...
# Export Sitecrawl as an alias for SitecrawlApp
SitecrawlApp = Sitecrawl
AsyncSitecrawlApp = AsyncSitecrawl
