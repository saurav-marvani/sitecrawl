...
This module provides a class `SitecrawlApp` for interacting with the Sitecrawl API.
...
Classes:
    - SitecrawlApp: Main class for interacting with the Sitecrawl API.
"""
import logging
import os
import time
...
# class SitecrawlDocumentMetadata(pydantic.BaseModel):
...
class SitecrawlDocument(pydantic.BaseModel, Generic[T]):
...
class ScrapeResponse(SitecrawlDocument[T], Generic[T]):
...
class SitecrawlApp:
    def __init__(self, api_key: Optional[str] = None, api_url: Optional[str] = None) -> None:
        """
        Initialize the SitecrawlApp instance with API key, API URL.
        ...
        logger.debug(f"Initialized SitecrawlApp with API URL: {self.api_url}")
...
class CrawlWatcher:
    ...
    Attributes:
        ...
        app (SitecrawlApp): The SitecrawlApp instance
    ...
    """
    def __init__(self, id: str, app: SitecrawlApp):
        self.id = id
        self.app = app
...
class AsyncSitecrawlApp(SitecrawlApp):
    """
    Asynchronous version of SitecrawlApp that implements async methods using aiohttp.
    Provides non-blocking alternatives to all SitecrawlApp operations.
    """
...
class AsyncCrawlWatcher(CrawlWatcher):
    ...
    """
    def __init__(self, id: str, app: AsyncSitecrawlApp):
